...
var _require = require('./connectSequelize'),
...
var RouteStudy = sequelize.define('route_study', {
  id_route: {
    type: DataTypes.INTEGER,
    allowNull: false,
    primaryKey: true
...
var PoolCourseCompleted = sequelize.define('pool_course_completed', {
  id_pool_course: {
    type: DataTypes.INTEGER,
    allowNull: false,
    primaryKey: true,
...
var PoolDocCompleted = sequelize.define('pool_doc_completed', {
  id_pool: {
    type: DataTypes.INTEGER,
    allowNull: false,
    primaryKey: true,
...
module.exports = {
  ...
  Learn: Learn,
  Doc: Doc,
  PoolCourseCompleted: PoolCourseCompleted,
  PoolDocCompleted: PoolDocCompleted
};